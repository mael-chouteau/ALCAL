...
def main(date, horaire, cours, prof, dateweek, promo):
    ...
    if H2 < 13:
        can.rect(81*mm, 177*mm, 2*mm, 1.75*mm, fill=1)
    else:
        can.rect(104*mm, 177*mm, 2*mm, 1.75*mm, fill=1)
    ...
    reference_pdf = PdfFileReader(open('./PDFs-presence/FichePrésence-'+secret.ANNEE[promo]+'.pdf', "rb"))
